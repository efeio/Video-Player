...
enum Query: String, CaseIterable {
    case racing, basketball, soccer, tennis, voleyball, gokart, archery, hockey, football, rugby, wrestling, cycling, pool, gymnastics, skating, croquet, handball, badminton, golf, baseball
}

class VideoManager: ObservableObject {
    @Published private(set) var videos: [Video] = []
    @Published var selectedQuery: Query = Query.racing {
    ...
    func findVideos(topic: Query) async {
        ...
        urlRequest.setValue("0LxonKaHs5O1yXC0tkXNdT0SIh7yTCO79TgUoMVKXsBD2MVQY8f6QGGV", forHTTPHeaderField: "Authorization")
